...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "vv-surface text-card-foreground flex flex-col gap-5 rounded-xl border py-5 shadow-[var(--vvisa-shadow-sm)]",
        className
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("text-vvisa-text-muted text-sm leading-relaxed", className)}
      {...props}
    />
  )
}
