...
export function MittoCareerHome() {
  ...
  return <main className="mitto-career min-h-screen overflow-hidden text-white"><div className="mitto-aurora" aria-hidden="true" />
    ...
    <footer className="relative z-10 border-t border-white/8 px-5 py-8"><div className="mx-auto flex max-w-[1480px] justify-between text-sm text-slate-500"><p>© 2026 Mitto Career.</p><p>career.V-VISA.in ready</p></div></footer>
  </main>;
}
