...
export const adminApplicationSubmitSchema=z.object({confirmation:z.literal('SUBMIT'),reason:z.string().min(8).max(500),walletDeduction:z.boolean().default(false),walletConfirmation:z.string().optional(),supportSessionId:z.string().optional()});
