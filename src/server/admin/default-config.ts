...
export const defaultApplicationStatuses: Array<{
  ...
  { code: 'READY_FOR_REVIEW', adminLabel: 'Ready for Review', partnerLabel: 'Documents Uploaded', partnerDescription: 'Documents are ready for V-VISA review.', colorToken: 'info', displayOrder: 30, progressPercent: 35, milestoneKey: 'documents-submitted' },
