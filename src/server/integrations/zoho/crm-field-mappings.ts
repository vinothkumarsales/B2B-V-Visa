...
export const crmFieldMappings = {
  Travel_Agents: {
    ...
    fields: [
      field('portalTravelAgentId', 'UID', true, 'cuid', 'PORTAL', 'CREATE_ONLY', 'NONE'),
      field('agencyName', 'Name', true, 'trim_spaces', 'SHARED', 'MANUAL_REVIEW', 'CONTACT'),
      field('verifiedMobile', 'Mobile', false, 'e164_india', 'PORTAL', 'PORTAL_OVERWRITES', 'CONTACT'),
      ...
      field('city', null, false, 'trim_spaces', 'PORTAL', 'PORTAL_OVERWRITES', 'CONTACT'),
      field('state', 'state', false, 'trim_spaces', 'PORTAL', 'PORTAL_OVERWRITES', 'CONTACT'),
      field('country', null, false, 'trim_spaces', 'PORTAL', 'PORTAL_OVERWRITES', 'CONTACT'),
      field('postalCode', null, false, 'trim_spaces', 'PORTAL', 'PORTAL_OVERWRITES', 'CONTACT'),
      field('portalSource', null, false, 'literal:V-Visa B2B Portal', 'PORTAL', 'CREATE_ONLY', 'NONE'),
    ],
  },
  Leads: {
    moduleKey: 'Leads',
