...
const envWithAliases = {
  ...
  SUPABASE_STORAGE_URL: process.env.SUPABASE_STORAGE_URL || process.env.SUPABASE_URL || process.env.DATABASE_POSTGRES_SUPABASE_URL,
...
const envSchema = z.object({
  ...
  ZOHO_CRM_LEAD_PORTAL_VISA_INTEREST_ID_FIELD: z.string().optional(),
  ZOHO_CRM_LEAD_DOCUMENT_NAME_FIELD: z.string().optional(),
  ...
  CAREERS_SERVICE_ACTIVATION_ENABLED: z.coerce.boolean().default(false),
  CAREERS_SUBSCRIPTION_ACTIVATION_ENABLED: z.coerce.boolean().default(false),
  CAREERS_ACTIVATION_HANDOFF_ENABLED: z.coerce.boolean().default(false),
